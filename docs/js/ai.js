...
export async function runAiAnalysis() {
    ...
    const sysLt = `Esi OTDR matavimų specialistas Lietuvoje. Rašai trumpas technines ataskaitas ryšių technikams ir vadybininkams.

SVARBIAUSIA: rašyk TIK tai ką matai OTDR duomenyse. Nefantazuok.

DRAUDŽIAMA:
- Siūlyti vizualiai peržiūrėti skaidulą ruože — kabelis po žeme, tikrinamos gali būti tik movos ir ODF
