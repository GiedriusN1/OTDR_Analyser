...
Programa gyvena `docs/` aplanke (iš jo veikia ir GitHub Pages versija) — žr. [docs/README.md](docs/README.md) dėl failų struktūros ir vietinio paleidimo.
...
- **Eksportas** – pilna Excel (XLSX), spausdinimui pritaikyta PDF ataskaita (su įkomponuotu šriftu lietuviškiems simboliams) ir viso aplanko suvestinės PDF.
...
└── README.md                     – šio failo dvikalbė kopija su docs/-specifine informacija
```
...
The app lives in the `docs/` folder (which is also what GitHub Pages serves) — see [docs/README.md](docs/README.md) for the file structure and local setup.
...
- **Export** – full Excel (XLSX), print-ready PDF reports (with an embedded font for Lithuanian characters), and a whole-folder summary PDF.
...
└── README.md                     – bilingual copy of this file with docs/-specific detail
```
